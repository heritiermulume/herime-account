<template>
  <div v-if="isRedirectingSSO || authStore.isSSORedirecting" class="fixed inset-0 z-[99999] bg-gray-50 dark:bg-gray-900 flex items-center justify-center" style="position: fixed !important; top: 0 !important; left: 0 !important; right: 0 !important; bottom: 0 !important; z-index: 99999 !important;">
